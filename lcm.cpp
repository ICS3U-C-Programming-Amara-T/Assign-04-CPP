...
int main() {
    // Greeting.
    std::cout <<
    "Hello! Let's find the LCM, remainder and multiples of 3 numbers!"
    << std::endl;
    ...
    try {
        ...
        user2_as_number = round(stof(user2_as_string));
            ...
            user3_as_number = round(stof(user3_as_string));
                        ...
                        && user3_as_number > 0) {
                            ...
                            switch (answer % 2) {
                                ...
                                case 1:
                                    std::cout << "The LCM " << answer
                                    << " of your inputs (" <<
                                    user1_as_number << ", " << user2_as_number
                                    << ", " << user3_as_number <<
                                    ")has a remainder of 1" << std::endl;
                                    break;
                                case 2:
                                    std::cout << "/n " << std::endl;
                                    break;
                            ...
                            std::cout <<
                            "The first three multiples of the LCM is:"
                            << std::endl;
                ...
                std::cout <<
                "The third input is not a number"
                << std::endl;
            }
        } catch (...) {
            std::cout <<
